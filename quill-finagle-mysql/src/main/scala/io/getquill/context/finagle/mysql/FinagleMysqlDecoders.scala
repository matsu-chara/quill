...
import io.getquill.context.finagle.mysql.FinagleMysqlDecoders.LowerPriorityImplicits
import io.getquill.util.Messages.fail

import scala.reflect.{ ClassTag, classTag }

trait FinagleMysqlDecoders extends LowerPriorityImplicits {
