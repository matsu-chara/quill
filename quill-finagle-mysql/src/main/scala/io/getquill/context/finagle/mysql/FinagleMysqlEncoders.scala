...
import io.getquill.context.finagle.mysql.FinagleMysqlEncoders.LowerPriorityImplicits

trait FinagleMysqlEncoders extends LowerPriorityImplicits {
...
object FinagleMysqlEncoders {

  trait LowerPriorityImplicits {
    self: FinagleMysqlContext[_] =>
